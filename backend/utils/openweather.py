...
def get_rain(lat:float, lon:float) -> Literal[0, 1, 2, 3]:
    ...
    if response.status_code == 200:
        ...
        if rain_volume < 0.5: return 1  # chuva fraca
        elif rain_volume < 2: return 2  # chuva moderada
        else: return 3  # chuva forte
    else:
        return 0